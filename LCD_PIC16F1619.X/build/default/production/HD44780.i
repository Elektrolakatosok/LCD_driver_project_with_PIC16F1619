...
void lcd_write(unsigned char c)
{
    ...
    if(c & 0x80) LATBbits.LATB7 = 1; else LATBbits.LATB7 = 0;
    if(c & 0x40) LATBbits.LATB6 = 1; else LATBbits.LATB6 = 0;
    if(c & 0x20) LATBbits.LATB5 = 1; else LATBbits.LATB5 = 0;
    if(c & 0x10) LATBbits.LATB4 = 1; else LATBbits.LATB4 = 0;
    ((LATCbits.LATC6 = 1), (_delay((unsigned long)((40)*(500000/4000000.0)))), (LATCbits.LATC6 = 0));
    if(c & 0x08) LATBbits.LATB7 = 1; else LATBbits.LATB7 = 0;
    if(c & 0x04) LATBbits.LATB6 = 1; else LATBbits.LATB6 = 0;
    if(c & 0x02) LATBbits.LATB5 = 1; else LATBbits.LATB5 = 0;
    if(c & 0x01) LATBbits.LATB4 = 1; else LATBbits.LATB4 = 0;
    ((LATCbits.LATC6 = 1), (_delay((unsigned long)((40)*(500000/4000000.0)))), (LATCbits.LATC6 = 0));
